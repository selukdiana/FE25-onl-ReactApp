            ...
            <div className="row post-top-meta authorpage">
              <div className="col-md-10 col-xs-12">
                ...
                <span className="author-description">
                  ...
                  and creator of <strong>"Mediumish"</strong> theme that you're
                  currently previewing. I professionally develop premium themes,
                  templates & scripts since the Apocalypse (2012). You can reach
                  me out on the social links below.
                </span>
